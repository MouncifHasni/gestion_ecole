...
echo " <br><br> <br> <br> <br><br><br><br>  <div class=\"card-group text-center\" style=\"\">
    <div class=\"inf height\">
     <a class=\"btn inf \" href=\"accueil1.php?res=1&res2=$res2\">
         <h4 >LA LISTE DES MODULES</h4><br><br>
     </a></div>
         <div class=\"inf height\">
     <a class=\"btn inf \" href=\"accueil1.php?res=2&res2=$res2\">
         <h4 >AJOUTER UNE MODULE</h4><br><br>
     </a></div>
              <div class=\"inf height\" >
     <a class=\"btn inf \" href=\"accueil1.php?res=3&res2=$res2\">
         <h4 >MODIFIER UNE MODULE</h4><br><br>
     </a></div>
                   <div class=\"inf height\">
     <a class=\"btn inf \" href=\"accueil1.php?res=4&res2=$res2\">
         <h4 >SUPPRIMER UNE MODULE</h4><br><br>
     </a></div>
        <div class=\"inf height\">
     <a class=\"btn inf \" href=\"accueil1.php?res=5&res2=$res2\">
         <h4 >LA GESTION DES ELEMENTS </h4><br><br>
     </a></div>
</div><br>     </div>
    ...
    <div>
         ";
              ...
              $sql1 ='SELECT * FROM Module WHERE code_f='.$res2.' ORDER BY nom_M';
...
echo "</div> </div> 
  ...
  <div class=\"text-center\" >
     ...
     <div class=\"card-body\">
     <form action=\"req.php?res=0.2&res3=$res2\" method=\"POST\" >
        <div class=\"text-center\"   >  
                <h2 class=\"text1\" id=\"ADMIN\" style=\"color:#02202e;\">Ajouter un module </h2>
        <div class=\"form-group\">
        <input type=\"text\" class=\"form-control\" id=\"text \" placeholder=\"Id\" name=\"id\">
        </div>   
        <div class=\"form-group\">
        <input type=\"text\" class=\"form-control\" id=\"text \" placeholder=\"Nom de module\" name=\"title\">
        </div>      
  ...
  <div class=\"card-group text-center\" style=\"\">
    <div class=\"inf height\">
     <button class=\"btn inf  dropdown-toggle\" data-toggle=\"collapse\" href=\"#e\" role=\"button\" aria-expanded=\"false\"  aria-controls=\"collapseExample\" style=\"text-decoration: none;\">
         <h1 class=\"\">MODIFIER UN MODULE</h1>
     </button></div>
 <div class=\"collapse inf2 height\" id=\"e\"> ";
      while ($row = $stmt1->fetch(PDO::FETCH_NUM, PDO::FETCH_ORI_NEXT)) {
      $id = $row[0];
      $title = $row[2];
 echo " <a href=\"accueil1.php?res1=$id&res2=$res2\" class=\"btn inf2\" style=\"text-decoration: none;\">
  <h2>$title</h2>
        </a>";              
    }
        ...
        echo "
              ...
              if($res==4){   
                  echo "<div > 
                    <h1 class=\"text-center \" style=\"color: white;\"><br><br>GESTION DES MODULES<br></h1>
                   <br>    
                   <h3 class=\"text-center \" style=\"color: white;\">Supprimer un module<br></h3>
<br>  
        <br>
    ...
    <div class=\"inf height\">";
      ...
      $id = $row[0];
      $title = $row[2];
  echo " <a href=\"req.php?res6=$id&res7=$res2\" class=\"btn inf2\"  onclick=\"return confirm('are you sure?');\">
  <h2>$title</h2></a>";             
    }
...
echo " 
        ...
        echo "
                  ...
                  echo "<div > 
                    <h1 class=\"text-center \" style=\"color: white;\"><br><br>GESTION DES MODULES<br></h1>
                   <br>    
                   <h3 class=\"text-center \" style=\"color: white;\">Gestion des éléments de module<br></h3>
<br>  
        <br>
    <br>     <div class=\"card-group text-center\" style=\"\">
    <div class=\"inf height\">";
...
while ($row = $stmt1->fetch(PDO::FETCH_NUM, PDO::FETCH_ORI_NEXT)) {
      $id = $row[0];
      $title = $row[2];
    echo " <a href=\"accueil2.php?res=1&res2=$id\" class=\"btn inf2\" >
    <h2>$title</h2></a>";             
    }
...
echo " 
      ...
      if(isset($_GET['res1'])){
    $res1=$_GET['res1'];
                        $sql2 ='SELECT * FROM Module WHERE code_f='.$res2.' ORDER BY nom_M';
 ...
 echo "<div > 
     ...
     <div class=\"card-body\">
     <form action=\"req.php?res4=$res1&res5=$res2\" method=\"POST\" >
     <div class=\"text-center\">";
